...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        public RemoteTables(DbConnection conn)
        {
            ...
            AddTable(Clocks = new(conn));
            AddTable(Games = new(conn));
            AddTable(Identifiables = new(conn));
            AddTable(Messages = new(conn));
            AddTable(Movables = new(conn));
            AddTable(Pingables = new(conn));
            AddTable(Routables = new(conn));
            AddTable(Schedules = new(conn));
            AddTable(Stats = new(conn));
        }
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            {
                "clear_all_identities" => BSATNHelpers.Decode<Reducer.ClearAllIdentities>(encodedArgs),
                "clear_identity" => BSATNHelpers.Decode<Reducer.ClearIdentity>(encodedArgs),
                ...
                "impulse" => BSATNHelpers.Decode<Reducer.Impulse>(encodedArgs),
                "impulse_all_balls" => BSATNHelpers.Decode<Reducer.ImpulseAllBalls>(encodedArgs),
                "join" => BSATNHelpers.Decode<Reducer.Join>(encodedArgs),
                "kick" => BSATNHelpers.Decode<Reducer.Kick>(encodedArgs),
                "move_to" => BSATNHelpers.Decode<Reducer.MoveTo>(encodedArgs),
                "ping" => BSATNHelpers.Decode<Reducer.Ping>(encodedArgs),
                "remove_all_balls" => BSATNHelpers.Decode<Reducer.RemoveAllBalls>(encodedArgs),
                "say" => BSATNHelpers.Decode<Reducer.Say>(encodedArgs),
                "set_game_auto_start" => BSATNHelpers.Decode<Reducer.SetGameAutoStart>(encodedArgs),
                "spawn_all_balls" => BSATNHelpers.Decode<Reducer.SpawnAllBalls>(encodedArgs),
                "spawn_space_balls" => BSATNHelpers.Decode<Reducer.SpawnSpaceBalls>(encodedArgs),
                "spawn_time_balls" => BSATNHelpers.Decode<Reducer.SpawnTimeBalls>(encodedArgs),
                "start_game" => BSATNHelpers.Decode<Reducer.StartGame>(encodedArgs),
                "start_infinite_game" => BSATNHelpers.Decode<Reducer.StartInfiniteGame>(encodedArgs),
                "test" => BSATNHelpers.Decode<Reducer.Test>(encodedArgs),
                "throw_to" => BSATNHelpers.Decode<Reducer.ThrowTo>(encodedArgs),
                "update" => BSATNHelpers.Decode<Reducer.Update>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.ClearAllIdentities args => Reducers.InvokeClearAllIdentities(eventContext, args),
                Reducer.ClearIdentity args => Reducers.InvokeClearIdentity(eventContext, args),
                ...
                Reducer.Impulse args => Reducers.InvokeImpulse(eventContext, args),
                Reducer.ImpulseAllBalls args => Reducers.InvokeImpulseAllBalls(eventContext, args),
                Reducer.Join args => Reducers.InvokeJoin(eventContext, args),
                Reducer.Kick args => Reducers.InvokeKick(eventContext, args),
                Reducer.MoveTo args => Reducers.InvokeMoveTo(eventContext, args),
                Reducer.Ping args => Reducers.InvokePing(eventContext, args),
                Reducer.RemoveAllBalls args => Reducers.InvokeRemoveAllBalls(eventContext, args),
                Reducer.Say args => Reducers.InvokeSay(eventContext, args),
                Reducer.SetGameAutoStart args => Reducers.InvokeSetGameAutoStart(eventContext, args),
                Reducer.SpawnAllBalls args => Reducers.InvokeSpawnAllBalls(eventContext, args),
                Reducer.SpawnSpaceBalls args => Reducers.InvokeSpawnSpaceBalls(eventContext, args),
                Reducer.SpawnTimeBalls args => Reducers.InvokeSpawnTimeBalls(eventContext, args),
                Reducer.StartGame args => Reducers.InvokeStartGame(eventContext, args),
                Reducer.StartInfiniteGame args => Reducers.InvokeStartInfiniteGame(eventContext, args),
                Reducer.Test args => Reducers.InvokeTest(eventContext, args),
                Reducer.ThrowTo args => Reducers.InvokeThrowTo(eventContext, args),
                Reducer.Update args => Reducers.InvokeUpdate(eventContext, args),
